...
// function StarRating({ rating, totalStars, size }) {
...
//     stars.push(<BsStarFill key={i} color="#FFAC0A" size={size} />);
//   }

//   // Add a half star if applicable
//   if (hasHalfStar) {
//     stars.push(<BsStarHalf key={fullStars} color="#FFAC0A" size={size} />);
//   }

//   // Add empty stars to complete the total number of stars
//   for (let i = 0; i < emptyStars; i++) {
//     stars.push(<BsStar key={fullStars + i} color="#FFAC0A" size={size} />);
//   }
