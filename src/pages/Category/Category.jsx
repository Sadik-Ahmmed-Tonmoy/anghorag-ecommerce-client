...
const Category = () => {
    ...
    const { isRefetchCategory, sortedValue, paginationValue, isReset, condition, setCondition } = useContext(ProviderContext);
        ...
        <div>
            ...
            <div className="md:flex container mx-auto">
                ...
                <div className="w-full">
                    <ShowProducts data={data} handleLoadMore={handleLoadMore} loading={loading} loadMoreURL={loadMoreURL} />
                </div>
            </div>
        </div>
    );
